...
const Store = {
  ...
  initializeData() {
    ...
    const opportunities = [
      ...
      { title: 'Stage en Data Science', company: c2.name, companyId: c2.id, category: 'stage', type: 'Stage', location: 'Gitega', salary: '300 000 BIF/mois', applyUrl: 'https://dataflow.bi/internships/ds', description: 'Offre de stage en Data Science.', requirements: ['Étudiant en informatique', 'Statistiques'], status: 'approved' },
